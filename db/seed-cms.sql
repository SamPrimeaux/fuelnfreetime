...
SELECT p.id, 'hero', 0,
  CASE p.slug
    WHEN 'home' THEN '{"titleLine1":"TIME IS THE","titleLine2":"REAL HORSEPOWER","subheadline":"For those who''ve earned their freedom — on two wheels, four wheels, water, or in the garage.","ctaLabel":"Explore More","ctaHref":"/shop"}'
