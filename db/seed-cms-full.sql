...
INSERT INTO page_sections (page_id, section_key, sort_order, content_json, status, updated_at)
SELECT p.id, 'hero', 0, '{"titleLine1":"TIME IS THE","titleLine2":"REAL HORSEPOWER","subheadline":"For those who''ve earned their freedom — on two wheels, four wheels, water, or in the garage.","ctaLabel":"Explore More","ctaHref":"/shop","glbUrl":"/media/3d-models/emblem-of-elegance.glb"}', 'published', datetime('now')
