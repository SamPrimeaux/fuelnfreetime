  ...
  function ensure() {
    ...
    root.innerHTML = `<style>
      ...
      *{box-sizing:border-box}[hidden]{display:none!important}
      .outline{position:fixed;border:2px solid #8b5cf6;border-radius:5px;background:#8b5cf614;pointer-events:none}
      ...
      .composer-row{display:flex;align-items:center;gap:7px;height:32px}.composer-logo{width:25px;height:25px;border-radius:50%;object-fit:cover;flex:none}.composer textarea{width:100%;height:30px;min-height:30px;max-height:150px;resize:none;overflow:hidden;border:0;background:transparent;color:#1b211c;font:14px/1.35 system-ui;padding:5px 2px;margin:0;outline:0}.composer.expanded textarea{height:88px;overflow:auto;resize:vertical}.composer textarea::placeholder{color:#717971}.composer button{min-height:30px;border:0;border-radius:50%;padding:0;font:inherit;cursor:pointer;background:transparent;color:#8b5cf6;display:grid;place-items:center}.composer .send{background:#8b5cf6;color:#fff;width:30px;height:30px;flex:none}.composer .mic{width:28px;height:30px;flex:none}.composer button:disabled{opacity:.5;cursor:wait}.composer .context,.composer label,.composer footer,.composer .reply,.composer .close{display:none}.composer .reply{white-space:pre-wrap;margin:8px 2px 0;color:#4b2d83;font-size:13px}.composer.expanded .reply{display:block}.composer.thinking textarea{color:#8b5cf6}.composer.thinking textarea::placeholder{color:#8b5cf6}.composer.thinking{box-shadow:0 0 0 2px #8b5cf633,0 14px 38px #18201826}
      ...
      :focus-visible{outline:3px solid #8b5cf6;outline-offset:3px}
    </style>
